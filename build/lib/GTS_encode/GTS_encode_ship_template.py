...
This encoding uses the toolbox developed by eccodes and 
it is adapted to encode mangopare sensors using the 
template for ship-deployed profiles
"""
...
from eccodes import *
from utils import extract_upcast, pres
